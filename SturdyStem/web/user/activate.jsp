...
<html>
 ...
 <body>
  ...
  try {
    ...
    // prepare data
    RSAPublicKey key = (RSAPublicKey)RSAKeyCache.genKey(uid);
    String m = CryptoUtil.byteToHex(key.getModulus().toByteArray());
    String e = CryptoUtil.byteToHex(key.getPublicExponent().toByteArray());
